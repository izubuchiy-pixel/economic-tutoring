...
<section class="entry-section entry-sources" id="sources"><div class="shell"><h2>参照資料・確認範囲</h2><ul>${d.sources.map(([title,href])=>`<li><a href="${esc(href)}" target="_blank" rel="noopener">${esc(title)}</a></li>`).join('')}</ul><p>確認日：2026年9月19日〜20日。${esc(d.boundary)} 復習案・例題の編集：economic_tutoring。</p></div></section>
